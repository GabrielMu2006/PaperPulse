            ...
            ScrollView {
                VStack(alignment: .leading, spacing: 16) {
                    MacBrandPageHeader(
                        ...
                        subtitle: language.text(en: "Language, discovery vocabulary, and local model profiles.", zh: "界面语言、发现词库与本地模型配置。")
                    )

                    settingsSection(language.text(en: "Language", zh: "语言")) {
                    ...
                    settingsSection(language.text(en: "Keyword Library", zh: "关键词库")) {
                        TextField(
                    ...
                    settingsSection(language.text(en: "Model Configurations", zh: "模型配置")) {
                    ...
                    settingsSection(language.text(en: "Storage", zh: "存储")) {
